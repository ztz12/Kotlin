...
public class StudentDb_Impl extends StudentDb {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"75ad1e187b21ef70d432d5a51bf8bb00\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsStudent.put("name", new TableInfo.Column("name", "TEXT", true, 0));
        ...
        if (! _infoStudent.equals(_existingStudent)) {
          throw new IllegalStateException("Migration didn't properly handle Student(com.example.zhangtianzhu.kotlindemo.bean.Student).\n"
                  + " Expected:\n" + _infoStudent + "\n"
                  + " Found:\n" + _existingStudent);
        }
      }
    }, "75ad1e187b21ef70d432d5a51bf8bb00", "3def29c9d47820525c11c15fdb0eed80");
